...
<footer className='  bg-[#171616] z-50'>
    <div className=" flex flex-col md:flex-row lg:flex-row w-full justify-between flex-wrap lg:-mt-24  md:-mt-28 mt-0 ">
    <div className=" flex lg:flex-row  lg:mx-12 mx-[20%] lg:ml-20  md:mx-[20%] items-center">
        <div className="lg:h-24 lg:w-24 md:h-32 md:w-32 h-20 w-20"> <Lottie animationData= {animationmap}/></div>
      <div className='lg:ml-8 ml-8 md:ml-20'>
        <p className="text-1.2xl lg:text-2xl md:text-3xl  font-barlow">Address</p>
        <p className="text-1.2xl   lg:text-2xl md:text-3xl font-barlow">NIT, Hamirpur<br />Himachal Pradesh,<br/> India, 177001</p>
      </div>
    </div>
    <div className=" flex lg:flex-row  lg:mx-12 mx-[20%] md:mt-12 lg:mt-0 mt-7 md:mx-[20%] items-center ">
    <div className="lg:h-20 lg:w-20 md:h-28 md:w-28 h-16 w-16"> <Lottie animationData= {animatiomcall}/></div>
      <div className=' ml-10 lg:ml-8 md:ml-24'>
        <p className="text-1.2xl lg:text-2xl md:text-3xl font-barlow">Phone</p>
        <p className="text-1.2xl lg:text-2xl md:text-3xl font-actor">12345578</p>
      </div>
    </div>
    <div className="lg:mr-20 flex lg:flex-row mt-7 lg:mx-12 md:mx-[20%] mx-[20%] items-center">
    <div className="lg:h-32 lg:w-32  md:h-48 md:w-48 h-28 w-28  -ml-6"> <Lottie animationData= {animatiomcontact}/></div>
      <div className='lg:ml-8 ml-4 md:ml-12 '>
        <p className="text-1.2xl  lg:text-2xl md:text-3xl font-barlow " >Email</p>
        <p className="text-1.2xl lg:text-2xl md:text-3xl font-barlow ">iste@nith.ac.in</p>
      </div>
    </div>
