...
<div className=" lg:h-[100rem] md:h-[75rem] h-[160rem] bg-[#171616] lg:-mt-[38%] md:-mt-[80%]  -mt-[140%]  text-white flex flex-col   p-4 ">
      ...
      <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:ml-[15%] md:ml-[5%] ml-0 lg:pt-7 pt-0 "> 
        ...
        <p className=" text-1.2xl lg:p-4  md:px-8 px-[7%] font-actor lg:w-96   pt-4  ">  Welcome to ISTE's Tech Domain! Serving as the organization's technological backbone, the Tech domain is responsible for delivering essential technical resources and support.
        </p>
        </div>
        ...
        <p className=" text-1.2xl pt-4 font-actor px-[7%] ">  The management of ISTE's financial activities falls within the purview of the Finance domain. It oversees activities such as accounting, financial reporting, and budgeting.
        </p></div>
        </div>
        ...
        <p className=" text-1.2xl pt-4 px-[7%] font-actor ">  The design team is the creative force to elevate society's visual, artistic, and aesthetic aspects. The Design team works to develop imaginatively captivating posters, graphics, and event branding.
        </p></div>
        </div>
        </div>
