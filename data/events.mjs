import Image from 'next/image'; // Ensure you are importing the correct Image component

export const Content = [
  {
    title: "Hult",
    image:"/assets/images/hult/DCS_0814.webp",
    last:"Last held in Jan 2023",
    sem:"Even Semester",
    description:
